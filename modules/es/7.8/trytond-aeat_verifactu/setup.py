...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-aeat_verifactu',
    download_url='https://github.com:nantic/trytond-aeat_verifactu.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-aeat_verifactu.git'
    },
    classifiers=[
