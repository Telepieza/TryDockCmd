...
:verify_docker
  ...
  echo.
  :: No se existen las imágenes y contenedores, siendo el arranque tcd la primera vez, se activa la instalación automática
  if "!CURRENT_VERSION!"=="" (
...
:menu
  ...
  call "%DIR_SCRIPT%banner.bat" "%TRYTON%"
  echo     ====================================================================================
  call :logger "%MENU%" "%MENU_TITLE% %TRYTON%:[!CURRENT_VER_MENU!]-[!CURRENT_PG_VERSION!] - %WORD_COMPANY%:%CURRENT_COMPANY_NAME%" "5"
  echo     ====================================================================================
  ...
  call :logger "%MENU%" " 8. %MENU-OPTION_8%" "5" 
  call :logger "%MENU%" " 9. !MENU-OPTION_9:VERSION=%CURRENT_VERSION%!" "5"
